...
const steps = [
  { num: '01', label: '12月 - 2月',     title: '与雇主达成共识',  desc: '雇主确认支持，并与律师确定职位及工资标准。' },
  { num: '02', label: '3月4日 - 19日',  title: '线上抽签注册',    desc: '注册窗口开放，在指定时间内完成电子抽签注册并缴纳注册费。' },
  { num: '03', label: '3月20日起',      title: '等待移民局抽签',  desc: '移民局完成抽签选取，结果通常于3月底前完成第一轮公布。' },
